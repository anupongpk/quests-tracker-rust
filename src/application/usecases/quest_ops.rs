...
use crate::domain::{
    repositories::{quest_ops::QuestQpsRepository, quest_viewing::QuestViewingRepository},
    value_objecs::quest_model::{AddQuestModel, EditQuestModel},
};

pub struct QuestOpsUseCase<T1, T2>
where
    T1: QuestQpsRepository + Send + Sync,
